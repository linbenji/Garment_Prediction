"""
===============================================================================
EVALUATION PIPELINE: HybridDrapeModel (v2)
===============================================================================
...
Usage:
    ...
    python eval_v2.py --checkpoint runs/method2_master/checkpoints/best.pt --baselines

    # With everything
    python eval_v2.py --checkpoint runs/method1_baseline/checkpoints/best.pt --save-meshes --baselines
"""
