...
CONFIG = {
    ...
    'use_laplacian':          False,
    'use_collision':          True,    # NEW: per-sample PyKeOps collision vs body cache
    ...
    'log_every':       10,
    'use_wandb':       True,
    'experiment_name': 'model_v3_midpoint_collision',
}
...
def build_loss_weighter(cfg, device):
    ...
    weighted_loss() below:
      [drape, strain, cls, (normal), (bending), (laplacian), (collision)].
    """
...
def weighted_loss(loss_weighter, cfg, d_loss, e_loss, c_loss,
                  n_loss, b_loss, lap_loss, col_loss):
