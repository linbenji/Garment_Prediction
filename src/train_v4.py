...
Method 3: CLS token cross-attention injection at GNN layers 3 and 6

Changes from v3:
  - Imports from models_v4 instead of models_v3
  - experiment_name changed to 'method3_crossattn'
  - Everything else identical to teammate's train_v3.py
...
from models_v4 import MasterDrapeModel, AutomaticLossWeighter, drape_loss  # [V4] updated import
...
CONFIG = {
    ...
    'log_every':       10,
    'use_wandb':       True,
    'experiment_name': 'method3_crossattn',  # [V4] updated experiment name
}
...
def main():
    ...
    model = MasterDrapeModel(
        ...
        cross_attn_layers = cfg['cross_attn_layers'],  # None = auto midpoint + final
    ).to(device)
