...
Single-sample inference for HybridDrapeModel.
Given a fabric type, body shape, size, and a reference image,
predicts the draped shirt mesh and saves it as a .obj file.

Usage:
    # Predict using a sample from the dataset by name
    python predict.py --checkpoint runs/method1_baseline/checkpoints/best.pt \
