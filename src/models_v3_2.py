...
def drape_loss(predicted_delta, target_delta, template_pos, edge_index, loss_weight,
               ...
               body_ids=None, get_body_data=None,        # new: per-sample collision via body cache
               body_pos=None, body_normals=None,         # legacy: single-body shortcut
    ...
    if body_ids is not None and get_body_data is not None and batch_idx is not None:
        # Per-sample loop with body cache. Single .tolist() syncs all body IDs at once.
