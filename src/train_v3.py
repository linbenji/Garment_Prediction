...
Supports normal consistency, bending energy, and Laplacian losses via config flags.
"""
...
CONFIG = {
    ...
    'use_laplacian':          False,   # NEW: mm-space smoothness, no vanishing gradient
