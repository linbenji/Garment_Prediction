"""
===============================================================================
EVALUATION PIPELINE: NonbelieverDrapeModel (v3.5)
===============================================================================
...
Usage:
    ...
    python eval_v3_5.py --checkpoint runs/method1_baseline/checkpoints/best.pt

    # Evaluate on val split
    python eval_v3_5.py --checkpoint runs/method1_baseline/checkpoints/best.pt --split val
    ...
    python eval_v3_5.py --checkpoint runs/method1_baseline/checkpoints/best.pt --save-meshes
...
from models_v3_5 import NonbelieverDrapeModel
